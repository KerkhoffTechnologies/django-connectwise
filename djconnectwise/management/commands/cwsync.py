    ...
    def __init__(self, *args, **kwargs):
        ...
        synchronizers = (
            ...
            ('company_note_type', sync.CompanyNoteTypesSynchronizer,
             _('Company Note Type')),
            ('company_team_role', sync.CompanyTeamRoleSynchronizer,
             _('Company Team Role')),
            ('priority', sync.PrioritySynchronizer, _('Priority')),
            ('project_status', sync.ProjectStatusSynchronizer,
             _('Project Status')),
            ('project_phase_status', sync.ProjectPhaseStatusSynchronizer,
             _('Project Phase Status')),
            ...
            ('project_phase', sync.ProjectPhaseSynchronizer,
             _('Project Phase')),
            ('project_role', sync.ProjectRoleSynchronizer,
             _('Project Role')),
            ('territory', sync.TerritorySynchronizer,
             _('Territory')),
            ('system_location', sync.SystemLocationSynchronizer,
             _('System Location')),
            ('department', sync.DepartmentSynchronizer,
             _('Department')),
            ('standard_note', sync.StandardNoteSynchronizer,
             _('Standard Note')),
