...
class Ticket(UpdateConnectWiseMixin, TimeStampedModel):
    ...
    ticket_predecessor = models.ForeignKey(
        'self', blank=True, null=True, on_delete=models.SET_NULL , related_name="ticket_predecessor_ticket"
    )
    merged_parent = models.ForeignKey(
        'self', blank=True, null=True, on_delete=models.SET_NULL , related_name="merged_parent_ticket"
    )
