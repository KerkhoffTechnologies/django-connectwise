    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('object', models.ForeignKey(blank=True, null=True, to='djconnectwise.Ticket')),
            ],
        ),
        migrations.CreateModel(
            name='ScheduleStatus',
        ...
        migrations.AddField(
            ...
            name='schedule_type',
            field=models.ForeignKey(to='djconnectwise.ScheduleType'),
        ),
        migrations.AddField(
            model_name='scheduleentry',
            name='status',
            field=models.ForeignKey(to='djconnectwise.ScheduleStatus'),
        ),
        migrations.AddField(
            model_name='scheduleentry',
            name='where',
